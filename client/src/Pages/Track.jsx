...
function Track() {
  ...
  // const [loggedRet, setLoggedRet] = useState();
  ...
  const loadBlockchaindata = async () => {
    ...
    if (networkData) {
      ...
      setMAN(man);
      const disCtr = await supplychain.methods.disCount().call();
      const dis = {};
      for (i = 0; i < disCtr; i++) {
        dis[i + 1] = await supplychain.methods.DIS(i + 1).call();
      }
      setDIS(dis);
      const retCtr = await supplychain.methods.retCount().call();
      const ret = {};
      for (i = 0; i < retCtr; i++) {
      ...
      <div className="container-xl">
        ...
        <section className="row">
          <article className="col-3">
            ...
            <p>
              <b>Supplier ID: </b>
              {RMS[MED[ID].RMSid].id_of_rawMaterialSupplier}
            </p>
            <p>
              <b>Name:</b> {RMS[MED[ID].RMSid].name_of_rawMaterialSupplier}
            </p>
            <p>
              <b>Place: </b>
              {RMS[MED[ID].RMSid].place_of_rawMaterialSupplier}
            </p>
          </article>
          <span>&#10132;</span>
          <article className="col-3">
            ...
            <p>
              <b>Manufacturer ID: </b>
              {MAN[MED[ID].MANid].id_of_manufacturer}
            </p>
            <p>
              <b>Name:</b> {MAN[MED[ID].MANid].name_of_manufacturer}
            </p>
            <p>
              <b>Place: </b>
              {MAN[MED[ID].MANid].place_of_manufacturer}
            </p>
          </article>
          <span>&#10132;</span>
          <article className="col-3">
            ...
            <p>
              <b>Distributor ID: </b>
              {DIS[MED[ID].DISid].id_of_distributor}
            </p>
            <p>
              <b>Name:</b> {DIS[MED[ID].DISid].name_of_distributor}
            </p>
            <p>
              <b>Place: </b>
              {DIS[MED[ID].DISid].place_of_distributor}
            </p>
          </article>
          <span>&#10132;</span>
          <article className="col-3">
            ...
            <p>
              <b>Retailer ID: </b>
              {RET[MED[ID].RETid].id_of_retailer}
            </p>
            <p>
              <b>Name:</b> {RET[MED[ID].RETid].name_of_retailer}
            </p>
            <p>
              <b>Place: </b>
              {RET[MED[ID].RETid].place_of_retailer}
            </p>
          </article>
          <span>&#10132;</span>
          <article className="col-3">
  ...
  const handlerSubmit = async (event) => {
    ...
    var ctr = await SupplyChain.methods.medicineCount().call();
    ...
    try {
      ...
      // <AlertBox title={"Invalid Medicine ID!!!"} />;
    }
  };
  ...
  for (let i = 1; i <= Object.keys(RET).length; i++) {
    if (RET[i][0] === currentaccount) {
      loggedRet = RET[i][1];
      // console.log("logRet set to: ", loggedRet);
    }
  }
    ...
    <div>
      ...
      <form onSubmit={handlerSubmit}>
        <input
          ...
          required
        />
        <button className="button glow-button" onSubmit={handlerSubmit}>
          Track
        </button>
      </form>
      {loggedRet && (
